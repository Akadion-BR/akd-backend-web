...
public class ConstantesEmail {
    ...
    public static final String INICIANDO_ACESSO_OBTENCAO_CLIENT_AWS_SES =
            "Iniciando acesso ao método de obtenção de client do Akadion na AWS SES...";
    ...
    public static final String AKADION_SISTEMAS =
            "Akadion - Soluções tecnológicas";
    ...
    public static final String TELEFONE_AKADION = "(11) 97981-5415";
    public static final String PARAGRAPH_EMAIL_ENVIADO_POR_AKADION =
            "<p style='width: 100%; display: flex; justify-content: center; font-size: 0.7rem; color: #272930; font-weight: 600;'>" +
                    "Este e-mail está sendo enviado pela Akadion - Soluções tecnológicas";
