...
import br.akd.svc.akadion.web.exceptions.models.StandartError;
...
public class ErpProxyUtils {
    ...
    public RuntimeException realizaTratamentoRetornoErroFeignException(FeignException feignException,
        ...
        try {
            ...
            StandartError feignErrorResponse = mapper.readValue(
                    feignException.contentUTF8(), StandartError.class);
            return new InvalidRequestException(feignErrorResponse.getError());
